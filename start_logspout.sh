...
docker-compose -p logspout -f docker-compose-swarm-logspout.yml -f docker-compose-swarm-logspout.swarm.yml up -d
docker-compose -p logspout -f docker-compose-swarm-logspout.yml -f docker-compose-swarm-logspout.swarm.yml scale logspout=`docker info 2>/dev/null | grep ^Nodes: | awk '{print $2}'`
